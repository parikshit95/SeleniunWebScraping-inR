...
#Reading and Compiling sites in Karnatak

data = read.table("KarnatakaAlt..txt", header = TRUE, sep = "\t") 
Village = as.character(data[,1])
n = length(Village)
...
locations =  ldply(list_Karnataka,function(x) geoCode(x))
